...
var Board = exports.Board = function () {
  function Board(numberOfRows, numberOfColumns, numberOfBombs) {
    ...
    this._numberOfBombs = numberOfBombs, this._numberOfTiles = numberOfRows * numberOfColumns, this._playerBoard = Board.generatePlayerBoard(numberOfRows, numberOfColumns), this._bombBoard = Board.generateBombBoard(numberOfRows, numberOfColumns, numberOfBombs);
  }
